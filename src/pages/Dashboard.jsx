...
const Dashboard = () => {
    ...
    return (
        <Layout>
            ...
            {/* Sticky Header Section */}
            {/* Sticky Header Section */}
            <div className="sticky top-0 z-40 bg-gray-50 dark:bg-navy-950 -mx-4 -mt-4 px-4 pt-[max(0px,env(safe-area-inset-top))] pb-2 mb-2 transition-all shadow-sm border-b border-gray-100 dark:border-navy-800">
                <h2 className="text-xl font-bold text-navy-900 dark:text-white mb-2 pt-2">Minggu Ini</h2>
